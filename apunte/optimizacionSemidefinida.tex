...
\include{chapter-programacionLineal}
\include{chapter-introduccionSDP}
\include{chapter-aplicaciones}
\include{chapter-aplicaciones-distancia}
\include{chapter-polinomios}
\include{chapter-momentos}
